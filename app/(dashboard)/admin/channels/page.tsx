...
export default function AdminChannelsPage() {
  ...
  if (loading) {
    return (
      <>
        <SubNav tabs={[{ label: "Param�tres", href: "/admin/settings" }, { label: "�quipe", href: "/admin/team" }, { label: "Channels", href: "/admin/channels" }, { label: "Mod�ration", href: "/admin/moderation" }, { label: "Outils", href: "/admin/tools" }, { label: "Audit", href: "/admin/audit" }, { label: "Logs", href: "/admin/error-logs" }]} />
