...
function m(e, o, t) {
  ...
  return (r) => {
    ...
    const u = e(r);
    if (!(u.length !== n.length || u.some((c, S) => n[S] !== c))) return i;
    n = u;
    let g;
    if (
...
function oe(e, o, t) {
  ...
  let r = {
    ...
    getLeafHeaders: () => {
      const l = [],
        u = (a) => {
          (a.subHeaders && a.subHeaders.length && a.subHeaders.map(u),
            l.push(a));
        };
      return (u(r), l);
    },
  ...
  createTable: (e) => {
    ((e.getHeaderGroups = m(
      ...
      (o, t, n, i) => {
        var r, l;
        const u =
            (r = n?.map((S) => t.find((d) => d.id === S)).filter(Boolean)) !=
            null
              ? r
              : [],
          a =
            (l = i?.map((S) => t.find((d) => d.id === S)).filter(Boolean)) !=
            null
              ? l
              : [],
          g = t.filter(
      ...
      (e.getLeftHeaderGroups = m(
        ...
        (o, t, n) => {
          var i;
          const r =
            (i = n?.map((l) => t.find((u) => u.id === l)).filter(Boolean)) !=
            null
              ? i
              : [];
          return G(o, r, e, "left");
...
function G(e, o, t, n) {
  ...
  const g = (d, s) => {
    ...
    c = o.map((d, s) => oe(t, d, { depth: l, index: s }));
  (g(c, l - 1), a.reverse());
  const S = (d) =>
    d
      ...
      .map((f) => {
        ...
        f.subHeaders && f.subHeaders.length
          ? ((w = []),
            S(f.subHeaders).forEach((h) => {
              let { colSpan: M, rowSpan: F } = h;
              ((p += M), w.push(F));
            }))
          : (p = 1);
        const v = Math.min(...w);
      ...
      (e.setFilterValue = (t) => {
        o.setColumnFilters((n) => {
          const i = e.getFilterFn(),
            r = n?.find((c) => c.id === e.id),
            l = x(t, r ? r.value : void 0);
          if (ie(i, l, e)) {
            var u;
...
const Fe = (e, o, t) =>
  ...
  Ie = (e, o) => Array.from(new Set(o.map((t) => t.getValue(e))).values()),
  ye = (e, o) => new Set(o.map((t) => t.getValue(e))).size,
  Ee = (e, o) => o.length,
  z = {
    sum: Fe,
    min: $e,
...
const He = {
    ...
    getDefaultOptions: (e) => ({ onColumnOrderChange: $("columnOrder", e) }),
    createColumn: (e, o) => {
      ((e.getIndex = m(
        (t) => [D(o, t)],
  ...
  O = () => ({ left: [], right: [] }),
  Ae = {
    getInitialState: (e) => ({ columnPinning: O(), ...e }),
    getDefaultOptions: (e) => ({
      ...
      ((e.pin = (t) => {
        ...
        (e.getIsPinned = () => {
          const t = e.getLeafColumns().map((u) => u.id),
            ...
            r = t.some((u) => n?.includes(u)),
            l = t.some((u) => i?.includes(u));
...
const H = { size: 150, minSize: 20, maxSize: Number.MAX_SAFE_INTEGER },
  B = () => ({
    startOffset: null,
    startSize: null,
    deltaOffset: null,
  ...
  ze = {
    ...
    createColumn: (e, o) => {
      ((e.getSize = () => {
        ...
        return Math.min(
          Math.max(
            (t = e.columnDef.minSize) != null ? t : H.minSize,
            (n = r ?? e.columnDef.size) != null ? n : H.size,
          ),
          (i = e.columnDef.maxSize) != null ? i : H.maxSize,
        );
      }),
        (e.getStart = m(
          (t) => [t, D(o, t), o.getState().columnSizing],
          (t, n) =>
        ...
        (e.getResizeHandler = (t) => {
          ...
          return (r) => {
            if (
              ...
              T(r) && r.touches && r.touches.length > 1)
            )
              return;
            const l = e.getSize(),
              u = e
                ...
                : [[n.id, n.getSize()]],
              a = T(r) ? Math.round(r.touches[0].clientX) : r.clientX,
              g = {},
              c = (w, v) => {
                typeof v == "number" &&
                  (o.setColumnSizingInfo((h) => {
                    ...
                    const y =
                      ...
                      ee = (v - ((M = h?.startOffset) != null ? M : 0)) * y,
                      te = Math.max(
                        ee / ((F = h?.startSize) != null ? F : 0),
                        -0.999999,
                      );
                    return (
                      h.columnSizingStart.forEach((pe) => {
                        let [Se, ne] = pe;
                        g[Se] =
                          Math.round(Math.max(ne + ne * te, 0) * 100) / 100;
                      }),
                      { ...h, deltaOffset: ee, deltaPercentage: te }
                    );
                  }),
                  (o.options.columnResizeMode === "onChange" || w === "end") &&
                    o.setColumnSizing((h) => ({ ...h, ...g })));
              },
              S = (w) => c("move", w),
              d = (w) => {
                (c("end", w),
              ...
              p = {
                ...
                upHandler: (w) => {
                  ...
                  (s?.removeEventListener("touchmove", p.moveHandler),
                    ...
                    w.cancelable && (w.preventDefault(), w.stopPropagation()),
                    d((v = w.touches[0]) == null ? void 0 : v.clientX));
                },
              },
              R = Oe() ? { passive: !1 } : !1;
            (T(r)
      ...
      ((e.setColumnSizing = (o) =>
        ...
        (e.resetHeaderSizeInfo = (o) => {
          ...
          e.setColumnSizingInfo(
            o ? B() : (t = e.initialState.columnSizingInfo) != null ? t : B(),
          );
        }),
        (e.getTotalSize = () => {
          var o, t;
...
const Te = {
  ...
  U = 0,
  X = 10,
  q = () => ({ pageIndex: U, pageSize: X }),
  je = {
    getInitialState: (e) => ({
      ...e,
      pagination: { ...q(), ...e?.pagination },
    }),
    getDefaultOptions: (e) => ({ onPaginationChange: $("pagination", e) }),
    createTable: (e) => {
      let o = !1,
        t = !1;
      ((e._autoResetPageIndex = () => {
        ...
        (e.setPageSize = (n) => {
          e.setPagination((i) => {
            const r = Math.max(1, x(n, i.pageSize)),
        ...
        (e.setPageCount = (n) =>
          e.setPagination((i) => {
            var r;
            let l = x(n, (r = e.options.pageCount) != null ? r : -1);
            return (
  ...
  Ne = {
    ...
    getDefaultOptions: (e) => ({ onRowPinningChange: $("rowPinning", e) }),
    createRow: (e, o) => {
      ((e.pin = (t, n, i) => {
        const r = n
            ? e.getLeafRows().map((a) => {
    ...
    createTable: (e) => {
      ((e.setRowSelection = (o) =>
        ...
        (e.getIsAllRowsSelected = () => {
          ...
          return (
            n && o.some((i) => i.getCanSelect() && !t[i.id]) && (n = !1),
            n
          );
        }),
    ...
    createRow: (e, o) => {
      ((e.toggleSelected = (t, n) => {
        ...
        o.setRowSelection((r) => {
          ...
          const u = { ...r };
          return (
            K(u, e.id, t, (l = n?.selectChildren) != null ? l : !0, o),
            u
          );
        });
      }),
  ...
  K = (e, o, t, n, i) => {
    ...
    (t
      ...
      n &&
        ...
        l.subRows.forEach((u) => K(e, u.id, t, n, i)));
  };
function j(e, o) {
...
const Q = /([0-9]+)/gm,
  Xe = (e, o, t) =>
    fe(I(e.getValue(t)).toLowerCase(), I(o.getValue(t)).toLowerCase()),
  Ke = (e, o, t) => fe(I(e.getValue(t)), I(o.getValue(t))),
  Je = (e, o, t) =>
    b(I(e.getValue(t)).toLowerCase(), I(o.getValue(t)).toLowerCase()),
  Qe = (e, o, t) => b(I(e.getValue(t)), I(o.getValue(t))),
  We = (e, o, t) => {
    const n = e.getValue(t),
      i = o.getValue(t);
    return n > i ? 1 : n < i ? -1 : 0;
  },
  Ye = (e, o, t) => b(e.getValue(t), o.getValue(t));
function b(e, o) {
...
const E = {
      ...
      ((e.getAutoSortingFn = () => {
        ...
        (e.toggleSorting = (t, n) => {
          const i = e.getNextSortingOrder(),
            r = typeof t < "u" && t !== null;
          o.setSorting((l) => {
            const u = l?.find((s) => s.id === e.id),
              a = l?.findIndex((s) => s.id === e.id);
            let g = [],
              c,
              S = r ? t : i === "desc";
            if (
              ...
              c === "toggle"
                ? (g = l.map((s) => (s.id === e.id ? { ...s, desc: S } : s)))
                : c === "remove"
  ...
  be = [ve, Be, He, Ae, he, _e, Te, qe, Ze, De, ke, je, Ne, Ue, ze];
function et(e) {
  var o, t;
  ...
  const r = i._features.reduce(
      (d, s) =>
        Object.assign(
          d,
          s.getDefaultOptions == null ? void 0 : s.getDefaultOptions(i),
        ),
      {},
    ),
    l = (d) =>
      i.options.mergeOptions ? i.options.mergeOptions(r, d) : { ...r, ...d };
  let a = { ...{}, ...((t = e.initialState) != null ? t : {}) };
  i._features.forEach((d) => {
    var s;
    a =
      (s = d.getInitialState == null ? void 0 : d.getInitialState(a)) != null
        ? s
        : a;
  });
  const g = [];
...
function nt(e, o, t) {
  return t.options.filterFromLeafRows ? ot(e, o, t) : it(e, o, t);
}
function ot(e, o, t) {
  var n;
  const i = [],
    ...
    u = function (a, g) {
      ...
      for (let d = 0; d < a.length; d++) {
        var S;
        let s = a[d];
        const f = W(t, s.id, s.original, s.index, s.depth, void 0, s.parentId);
        if (
        ...
        } else ((s = f), o(s) && (c.push(s), (r[s.id] = s), i.push(s)));
      }
      return c;
    };
  return { rows: u(e), flatRows: i, rowsById: r };
}
function it(e, o, t) {
  var n;
  const i = [],
    ...
    m(
      ...
      (t, n) => {
        ...
        (o.options.paginateExpandedRows
          ? (S = { rows: l, flatRows: u, rowsById: a })
          : (S = tt({ rows: l, flatRows: u, rowsById: a })),
          (S.flatRows = []));
        const d = (s) => {
          ...
          return (
            ...
            g.forEach((c) => {
              ...
              (i.push(c),
                (S = c.subRows) != null &&
                  S.length &&
                  (c.subRows = u(c.subRows)));
            }),
            g
          );
        };
        return { rows: u(t.rows), flatRows: i, rowsById: t.rowsById };
      },
...
function pt(e, o) {
  return e ? (rt(e) ? N.createElement(e, o) : e) : null;
}
function rt(e) {
  return lt(e) || typeof e == "function" || st(e);
}
function lt(e) {
  return (
    typeof e == "function" &&
...
function St(e) {
  const o = {
    ...
    [t] = N.useState(() => ({ current: et(o) })),
    [n, i] = N.useState(() => t.current.initialState);
  return (
...
export { gt as a, dt as b, at as c, ct as d, pt as f, ft as g, St as u };
