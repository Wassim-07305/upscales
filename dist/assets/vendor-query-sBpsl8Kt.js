...
function xt() {
  ...
  function s(i, r, a) {
    ...
    if (
      ...
      a = {};
      for (var n in r) n !== "key" && (a[n] = r[n]);
    } else a = r;
    return (
      (r = a.ref),
      { $$typeof: t, type: i, key: o, ref: r !== void 0 ? r : null, props: a }
    );
  }
  return ((A.Fragment = e), (A.jsx = s), (A.jsxs = s), A);
}
var nt;
function Qt() {
  return (nt || ((nt = 1), (G.exports = xt())), G.exports);
}
var Tt = Qt(),
  I = class {
    constructor() {
...
function at(t, e) {
  ...
  if (o) {
    ...
    } else if (!j(e.queryKey, o)) return !1;
  }
  if (s !== "all") {
    const h = e.isActive();
...
function gt(t) {
  return (t ?? "online") === "online" ? N.isOnline() : !0;
}
...
function bt(t) {
  ...
  const r = J(),
    ...
    l = () =>
      et.isFocused() &&
      (t.networkMode === "always" || N.isOnline()) &&
      t.canRun(),
    u = () => gt(t.networkMode) && t.canRun(),
    p = (f) => {
      a() || (i?.(), r.resolve(f));
    },
    c = (f) => {
    ...
    d = () => {
      ...
      Promise.resolve(f)
        ...
        .catch((O) => {
          if (a()) return;
          const S = t.retry ?? (Q ? 0 : 3),
            w = t.retryDelay ?? Bt,
            F = typeof w == "function" ? w(s, O) : w,
            M =
              S === !0 ||
              (typeof S == "number" && s < S) ||
...
var Ot = class {
    ...
    clearGcTimeout() {
      this.#t && (x.clearTimeout(this.#t), (this.#t = void 0));
    }
  },
  zt = class extends Ot {
    #t;
    ...
    setOptions(t) {
      if (
        ...
        const e = lt(this.options);
        e.data !== void 0 &&
          (this.setState(ct(e.data, e.dataUpdatedAt)), (this.#t = e));
      }
    }
    optionalRemove() {
    ...
    setData(t, e) {
      const s = W(this.state.data, t, this.options);
      return (
        this.#n({
          data: s,
          type: "success",
    ...
    isStatic() {
      return this.getObserversCount() > 0
        ? this.observers.some((t) => E(t.options.staleTime, this) === "static")
        : !1;
    }
    isStale() {
      return this.getObserversCount() > 0
...
var Rt = class extends I {
  ...
  onSubscribe() {
    this.listeners.size === 1 &&
      ...
      ft(this.#e, this.options) ? this.#l() : this.updateResult(),
      this.#b());
  }
  onUnsubscribe() {
  ...
  shouldFetchOnReconnect() {
    return V(this.#e, this.options, this.options.refetchOnReconnect);
  }
  ...
  setOptions(t) {
    ...
    if (
      ...
      this.options.enabled !== void 0 &&
        ...
        typeof R(this.options.enabled, this.#e) != "boolean")
    )
      throw new Error(
    ...
    (i && dt(this.#e, s, this.options, e) && this.#l(),
      this.updateResult(),
      i &&
        (this.#e !== s ||
          R(this.options.enabled, this.#e) !== R(e.enabled, this.#e) ||
          E(this.options.staleTime, this.#e) !== E(e.staleTime, this.#e)) &&
        this.#v());
    const r = this.#m();
    i &&
      (this.#e !== s ||
  ...
  #v() {
    this.#O();
    const t = E(this.options.staleTime, this.#e);
    if (Q || this.#r.isStale || !B(t)) return;
    const s = yt(this.#r.dataUpdatedAt, t) + 1;
    this.#h = x.setTimeout(() => {
  ...
  #g(t) {
    (this.#P(),
      ...
      !(
        Q ||
        R(this.options.enabled, this.#e) === !1 ||
        !B(this.#u) ||
        this.#u === 0
      ) &&
        (this.#c = x.setInterval(() => {
          (this.options.refetchIntervalInBackground || et.isFocused()) &&
            this.#l();
        }, this.#u)));
  }
  #b() {
  ...
  #O() {
    this.#h && (x.clearTimeout(this.#h), (this.#h = void 0));
  }
  #P() {
    this.#c && (x.clearInterval(this.#c), (this.#c = void 0));
  }
  createResult(t, e) {
    const s = this.#e,
      i = this.options,
      ...
      (r?.isPlaceholderData && e.placeholderData === o?.placeholderData
        ...
        : (P =
            typeof e.placeholderData == "function"
              ...
              : e.placeholderData),
        P !== void 0 && ((f = "success"), (c = W(r?.data, P, e)), (p = !0)));
    }
    ...
    const O = u.fetchStatus === "fetching",
      ...
      C = {
        ...
        isFetchedAfterMount:
          u.dataUpdateCount > h.dataUpdateCount ||
          u.errorUpdateCount > h.errorUpdateCount,
        isFetching: O,
        isRefetching: O && !S,
        isLoadingError: w && !M,
    ...
    if (this.options.experimental_prefetchInRender) {
      const P = C.data !== void 0,
        D = C.status === "error" && !P,
        q = (k) => {
          D ? k.reject(C.error) : P && k.resolve(C.data);
        },
        it = () => {
          const k = (this.#o = C.promise = J());
          q(k);
        },
        U = this.#o;
      switch (U.status) {
        case "pending":
          t.queryHash === s.queryHash && q(U);
          break;
        case "fulfilled":
          (D || C.data !== U.value) && it();
          break;
        case "rejected":
          (!D || C.error !== U.reason) && it();
          break;
      }
    }
    return C;
...
function ft(t, e) {
  return Wt(t, e) || (t.state.data !== void 0 && V(t, e, e.refetchOnMount));
}
function V(t, e, s) {
  if (R(e.enabled, t) !== !1 && E(e.staleTime, t) !== "static") {
    const i = typeof s == "function" ? s(t) : s;
    return i === "always" || (i !== !1 && st(t, e));
  }
  return !1;
}
function dt(t, e, s, i) {
...
function st(t, e) {
  return R(e.enabled, t) !== !1 && t.isStaleByTime(E(e.staleTime, t));
}
function Jt(t, e) {
    ...
    onFetch: (e, s) => {
      ...
      const l = async () => {
        ...
        if (r && a.length) {
          ...
          const d = t ?? a.length;
          do {
            const f = h === 0 ? (o[0] ?? i.initialPageParam) : Y(i, n);
            if (h > 0 && f == null) break;
            ((n = await v(n, f)), h++);
          } while (h < d);
        }
...
function Vt(t, e) {
  return !e || !t.getPreviousPageParam ? !1 : St(t, e) != null;
}
...
var Xt = class extends I {
  ...
  find(t) {
    const e = { exact: !0, ...t };
    return this.getAll().find((s) => ot(e, s));
  }
  findAll(t = {}) {
  ...
  resumePausedMutations() {
    ...
    return y.batch(() => Promise.all(t.map((e) => e.continue().catch(b))));
  }
};
function _(t) {
...
var te = class extends I {
  ...
  ee = class extends I {
    ...
    find(t) {
      const e = { exact: !0, ...t };
      return this.getAll().find((s) => at(e, s));
    }
    findAll(t = {}) {
      const e = this.getAll();
      return Object.keys(t).length > 0 ? e.filter((s) => at(t, s)) : e;
    }
    notify(t) {
      y.batch(() => {
        this.listeners.forEach((e) => {
  ...
  de = class {
    ...
    #n;
    constructor(t = {}) {
      ((this.#t = t.queryCache || new ee()),
        (this.#e = t.mutationCache || new Xt()),
    ...
    mount() {
      (this.#a++,
        this.#a === 1 &&
          ((this.#o = et.subscribe(async (t) => {
            t && (await this.resumePausedMutations(), this.#t.onFocus());
          })),
          (this.#n = N.subscribe(async (t) => {
    ...
    ensureQueryData(t) {
      ...
      return i === void 0
        ? this.fetchQuery(t)
        : (t.revalidateIfStale &&
            s.isStaleByTime(E(e.staleTime, s)) &&
    ...
    fetchQuery(t) {
      ...
      return s.isStaleByTime(E(e.staleTime, s))
        ? s.fetch(e)
    ...
    resumePausedMutations() {
      return N.isOnline() ? this.#e.resumePausedMutations() : Promise.resolve();
    }
    getQueryCache() {
      return this.#t;
    }
    ...
    getQueryDefaults(t) {
      ...
      return (
        e.forEach((i) => {
          j(t, i.queryKey) && Object.assign(s, i.defaultOptions);
        }),
        s
      );
    }
    ...
    getMutationDefaults(t) {
      ...
      return (
        e.forEach((i) => {
          j(t, i.mutationKey) && Object.assign(s, i.defaultOptions);
        }),
        s
      );
    }
  ...
  Ct = m.createContext(void 0),
  Et = (t) => {
    const e = m.useContext(Ct);
    if (!e)
  ...
  pe = ({ client: t, children: e }) => (
    ...
    Tt.jsx(Ct.Provider, { value: t, children: e })
  ),
  Ft = m.createContext(!1),
  se = () => m.useContext(Ft);
Ft.Provider;
function ie() {
  let t = !1;
...
var re = m.createContext(ie()),
  ne = () => m.useContext(re),
  ae = (t, e, s) => {
    const i =
      s?.state.error && typeof t.throwOnError == "function"
        ? tt(t.throwOnError, [s.state.error, s])
        : t.throwOnError;
  ...
  ue = ({
    ...
    !t.isFetching &&
    i &&
    ((r && t.data === void 0) || tt(s, [t.error, i])),
  he = (t) => {
    if (t.suspense) {
  ...
  ce = (t, e) => t.isLoading && t.isFetching && !e,
  le = (t, e) => t?.suspense && e.isPending,
  pt = (t, e, s) =>
...
function Mt(t, e, s) {
  ...
  if (
    (m.useSyncExternalStore(
      m.useCallback(
        (c) => {
          const v = p ? l.subscribe(y.batchCalls(c)) : b;
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !Q &&
      ce(u, i) &&
      (h ? pt(o, l, r) : n?.promise)?.catch(b).finally(() => {
        l.updateResult();
      }),
...
function ve(t, e) {
  const s = Et(),
    [i] = m.useState(() => new te(s, t));
  m.useEffect(() => {
    i.setOptions(t);
  }, [i, t]);
  const r = m.useSyncExternalStore(
      m.useCallback((o) => i.subscribe(y.batchCalls(o)), [i]),
      () => i.getCurrentResult(),
      () => i.getCurrentResult(),
    ),
    a = m.useCallback(
  ...
  if (r.error && tt(i.options.throwOnError, [r.error])) throw r.error;
  return { ...r, mutate: a, mutateAsync: r.mutate };
}
function me(t, e) {
  return Mt(t, Yt);
}
export { de as Q, Et as a, ve as b, pe as c, me as d, Tt as j, ye as u };
