...
export const puckConfig: Config = {
  categories: {
    "Sections principales": {
      components: ["Hero", "HeroScaling", "CTA", "TextImage", "Features", "HowItWorks", "Pricing", "PricingSingle"],
    },
    "Contenu": {
      components: ["RichText", "VideoEmbed", "FAQ", "Testimonials", "TestimonialsEnhanced"],
    },
    "Conversion": {
