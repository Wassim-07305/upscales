...
export type CallStatus = "planifié" | "effectué" | "annulé" | "no_show" | "reporté";
export type CloserCallStatus = "closé" | "non_closé" | "perdu" | "no_show" | "paiement_reussi" | "paiement_echoue" | "en_attente";
export type FinancialEntryType = "ca" | "récurrent" | "charge" | "prestataire";
export type FinancialRecurrence = "ponctuel" | "mensuel" | "trimestriel" | "annuel";
