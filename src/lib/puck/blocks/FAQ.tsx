    ...
    items: [
      {
        ...
        answer:
          "Inscrivez-vous, accédez aux contenus et progressez à votre rythme.",
      },
      {
        question: "Y a-t-il un engagement ?",
        answer: "Non, vous pouvez annuler à tout moment sans frais.",
      },
      {
        question: "Puis-je obtenir un certificat ?",
        answer: "Oui, un certificat est délivré à la fin de chaque formation.",
      },
    ],
  },
