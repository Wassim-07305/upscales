...
export const Hero: ComponentConfig<HeroProps> = {
  ...
  defaultProps: {
    ...
    subtitle:
      "Rejoignez notre programme et développez les compétences qui feront la différence.",
      ...
      >
        ...
        {subtitle && (
          <p
            ...
            style={
              alignment === "center" ? { marginInline: "auto" } : undefined
            }
          >
            {subtitle}
          </p>
        ...
        <div
          ...
          style={
            alignment === "center" ? { justifyContent: "center" } : undefined
          }
        >
          {ctaText && (
            <a
