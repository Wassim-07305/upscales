-- ============================================
-- UPSCALE DB: Full schema from Off-Market
-- Generated via: supabase db dump
-- ============================================
...
BEGIN
    ...
    END LOOP;
    FOR r IN (SELECT p.oid, proname, oidvectortypes(proargtypes) as args FROM pg_proc p WHERE pronamespace = 'public'::regnamespace) LOOP
